...
const Search = props => {
  ...
  if (params.has("search")) {
    const searchText = decodeURIComponent(params.get("search"));
    const input = document.getElementById("search_input_react");
    ...
    if (input) {
      ...
      input.dispatchEvent(new Event("input", { bubbles: true })); // Important for React
    }
  }
}, [indexReady]);
