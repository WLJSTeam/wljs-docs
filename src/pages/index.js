    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        <div onMouseEnter={handleMouseEnter}
            ...
            style={{width: 'auto', 'min-height': 420, 'border-radius': '6px', 'padding': '1em', 'background': isHover ? 'white' : 'none'}}
            >
        <div style={{display: isHover ? 'none' : 'block'}}> 
          <Sandbox 
        ...
        <div style={{display: !isHover ? 'none' : 'block', 'text-align':'left'}}> 
         <Component></Component> 
